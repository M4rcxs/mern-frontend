        ...
        <div className="flex flex-col h-screen w-screen relative">
            ...
            <div className="flex flex-1 flex-col lg:flex-row">
                <div className="flex-1 p-4 lg:p-6">
                    ...
                    >
                        <TileLayer url={`https://api.maptiler.com/maps/streets/{z}/{x}/{y}.png?key=${import.meta.env.VITE_MAP_KEY}`} />
            ...
            <div
                className={`lg:hidden fixed bottom-0 left-0 w-full bg-white rounded-t-2xl shadow-2xl transition-transform duration-300 z-[9999] ${showDashboard ? "translate-y-0" : "translate-y-full"
                    }`}
